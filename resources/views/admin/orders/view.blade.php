    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="shadow bg-white p-3 card-header">
                    <h4 class="text-secondary">
                        ...
                        <a href="{{ url('admin/invoice/'.$order->id.'/generate') }}" class="btn btn-danger btn-sm float-end mx-1" title=" Download Invoice">
                            <i class="fa fa-download" aria-hidden="true"></i>
                           </a>

                        <a href="{{ url('admin/invoice/'.$order->id) }}" class="btn btn-primary btn-sm float-end mx-1" title="View Invoice" target="_blank">

                            <i class="fa fa-eye" aria-hidden="true"></i>
                        </a>
                        <a href="{{ url('admin/invoice/'.$order->id.'/mail') }}" class="btn btn-info text-black btn-sm float-end mx-1" title="Send Invoice Via Mail">
