...
<div class="row">
    <div class="col-md-12">
        ...
        @if (session('msg'))
        <h5 class="alert alert-success mb-2">{{ session('msg') }}</h5>
    @endif
        ...
        <div class="card-header">
            <h3>Edit Product
                <a href="{{ url('admin/products') }}" class="btn btn-warning btn-sm  float-end">Back</a>
            </h3>
        </div>
                ...
                <div class="tab-pane fade border p-3" id="image-tab-pane" role="tabpanel" aria-labelledby="image-tab" tabindex="0">
                    ...
                    <div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-2">
                                <img src="{{ asset($image->image) }}" style="width: 80px; height: 80px" class="me-3 border" alt="Image" />
                    ...
                    <div class="mb-3">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 mt-3">
                              ...
                              Quantity: <input type="number" min="1" name="colorquantity[{{ $colorItem->id  }}]" style="border: 1px solid black; width: 70px">
                            </div>
                        </div>
                            @empty
                            <div class="col-md-12">

                                <h5 class="alert alert-warning">No colors found!</h5>
                            </div>
                            @endforelse
                        ...
                        <table class="table table-sm table-bordered">
                            ...
                            <tbody >
                                ...
                                <td>
                                    ...
                                    <input type="number" value="{{ $prodColor->quantity }}" class="colorQty form-control form-control-sm">

                                    <button type="button" value="{{ $prodColor->id }}" class="updateColor btn btn-primary btn-sm text-white">Update</button>
                                </div>
                                </td>
                                ...
                                <td>
                                    ...
                                    <button type="button" value="{{ $prodColor->id }}" class="deleteColor btn btn-danger btn-sm text-white">Delete</button>
...
<script>
    $(document).ready(function () {
        ...
        $(document).on('click', '.updateColor', function () {
            ...
            var qty = $(this).closest('.prod-color-tr').find('.colorQty').val();
            // alert(prod_color_id);
