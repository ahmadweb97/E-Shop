...
<div class="row">
    <div class="col-md-12 grid-margin">
        ...
        @if (session('msg'))
        <h2 class="alert alert-info">{{ session('msg') }}</h2>
        @endif

        <div class="me-md-3 me-xl-5">
            <h2>Dashboard,</h2>
            <p class="mb-md-0">Your analytics dashboard statistic.</p>
          </div>
          <hr>
          <div class="row">
            <div class="col-md-3">
            ...
            <div class="col-md-3">
                <div class="card card-body bg-warning mb-3">
                    ...
                    <a href="{{ url('admin/orders') }}" class="text-dark">View</a>
                </div>
            </div>
            <div class="col-md-3">
          ...
          <div class="row">
            ...
            <div class="col-md-3">
                <div class="card card-body bg-warning mb-3">
                    ...
                    <h1>{{ $totalBrands }}</h1>
                    <a href="{{ url('admin/brands') }}" class="text-dark">View</a>
                </div>
            </div>
          </div>
          ...
          <div class="row">
            ...
            <div class="col-md-3">
                <div class="card card-body bg-light  mb-3">
                    ...
                    <h1>{{ $totalAdmin }}</h1>
                    <a href="{{ url('admin/users') }}" class="text-dark">View</a>
                </div>
            </div>
          </div>
